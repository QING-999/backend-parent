package com.mooc.meetingfilm.backend.user.generator;
...
public class EntityGenerator {
    ...
    private String outputDir = "D:\\idealProject\\backend-parent\\backend-service\\src\\main\\java";
    // 生成类的作者
    private String author = "JC";
    // 数据源相关配置
    ...
    // DAO的包路径
    private String daoPackage = "com.mooc.meetingfilm.backend.service";
    // 待生成的表名，注意是覆盖更新
